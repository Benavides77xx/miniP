 ...
 * @author Lenovo
 */
public class Consultar_Eliminar_Habilidades extends javax.swing.JFrame {

    /**
     * Creates new form Consultar_Eliminar_Habilidades
     */
    public Consultar_Eliminar_Habilidades() {
        initComponents();
    }
    ...
    public void Filtro(ObjectContainer basep) {
        ...
        if (jCBfiltro.getSelectedIndex() == 0) {
            ...
            if (jCBfiltro.getSelectedIndex() == 1) {
                Habilidades Abuscar = new Habilidades(null, null, null);
                ...
                if (jCBfiltro.getSelectedIndex() == 2) {
                    ...
                    Habilidades Abuscar = new Habilidades(jTFid, null, null);
                    ObjectSet result = basep.get(Abuscar);
                    mostrarDatos(result);
    ...
    public void mostrarDatos(ObjectSet result) {
        ...
        if (result.size() == 0) {
            JOptionPane.showMessageDialog(null, "La Habilidadad no existe");
        } else {
    ...
    private void initComponents() {
        ...
        jCBfiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una opción", "Ver todos", "ID Habilidades", " ", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Eliminar_Habilidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Eliminar_Habilidades().setVisible(true);
            }
        });
    }
