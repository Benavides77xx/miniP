...
public class EncuestaFactura_ConsultarEliminar extends javax.swing.JFrame {
    ...
    public EncuestaFactura_ConsultarEliminar() {
     ...
     if (eleccion.getSelectedIndex() == 0) {
            ...
            if (eleccion.getSelectedIndex() == 2) {
                Encuesta_factura bus_tec = new Encuesta_factura(null,null,0,null);
                ...
                if (eleccion.getSelectedIndex() == 1) {
                    ...
                    Encuesta_factura buscartcc = new Encuesta_factura(opc,null,0,null);
    ...
    public void mostrarDatos(ObjectSet result) {
        ...
        if (result.size() == 0) {
            ...
            while (result.hasNext()) {
                Encuesta_factura mitick = (Encuesta_factura) result.next();
                Object[] fila = {
                    mitick.getCodigo_enc_fact(),
                    mitick.getFecha(),
                    mitick.getTotal(),
                    mitick.getId_cliente(),
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Encuesta Factura");
        ...
        jLabel2.setText("diguite el codigo de el ticket que desea eliminar : ");
        ...
        jPanel1.add(eleccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 150, 20));
        ...
        jPanel1.add(eliminardt, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 140, 190, 30));
        ...
        tablatec.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓD_ENC_FAC", "Fecha", "Total", "ID_cliente"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 700, 90));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 430, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       String cod_enc_fact = eliminardt.getText();

        // Abre la base de datos
        ObjectContainer baseDeDatos = Db4o.openFile(jose.INICIO.direccionBD);

        try {
            // Verifica si existen Detalles de facturas asociados a esta encuesta
            Detalle_factura cass = new Detalle_factura(null,0,0,null,cod_enc_fact );
            ObjectSet result = baseDeDatos.get(cass);
            if (result.size() > 0) {
                JOptionPane.showMessageDialog(this, "No se puede eliminar la encuesta, ya que tiene Detalles de facturas asociadas","ERROR",0);
                return;
            }

            // Busca la encuesta
            Encuesta_factura revisar = new Encuesta_factura(cod_enc_fact, null,0,null);
            ObjectSet cassResult = baseDeDatos.get(revisar);

            if (cassResult.size() == 0) {
                JOptionPane.showMessageDialog(null, "La encuesta no existe");
            } else {
                // Elimina el cassete encontrado
                baseDeDatos.delete(cassResult.get(0));
                JOptionPane.showMessageDialog(null, "La encuesta se ha eliminado correctamente");
