 ...
 */
public class Area_ConsultarEliminar extends javax.swing.JFrame {

    /**
     * Creates new form Area_ConsultarEliminar
     */
    public Area_ConsultarEliminar() {
        initComponents();
    }
    ...
    public void Filtro(ObjectContainer basep) {
        if (BuscarOpcion.getSelectedIndex() == 0) {
            ...
            if (BuscarOpcion.getSelectedIndex() == 1) {
                Area buscar = new Area(null, null, null, 0, false, null, null, null);
                ObjectSet result = basep.get(buscar);
                MostrarDatos(result);

            } else {
                if (BuscarOpcion.getSelectedIndex() == 2) {
                    String codigo_area = JOptionPane.showInputDialog("INGRESE EL CODIGO A CONSULTAR");
                    Area Jbuscar = new Area(codigo_area, null, null, 0, false, null, null, null);
    ...
    public void MostrarDatos(ObjectSet result) {
        ...
        String matrizes[][] = new String[result.size()][8];

        if (result.size() == 0) {
            JOptionPane.showMessageDialog(null, "El Area no existe");
        } else {
            for (int i = 0; i < result.size(); i++) {
                Area miObjeto = new Area();

                miObjeto = (Area) result.get(i);
                matrizes[i][0] = miObjeto.getCod_area();
                matrizes[i][1] = miObjeto.getNombre();
                matrizes[i][2] = miObjeto.getTamaño();
                matrizes[i][3] = String.valueOf(miObjeto.getCapacidad());
                matrizes[i][4] = String.valueOf(miObjeto.isDisponibilida());
                matrizes[i][5] = miObjeto.getDescripcion();
                matrizes[i][6] = miObjeto.getId_guardia();
                matrizes[i][7] = miObjeto.getCod_puesto();
                        
                tablaConsultar.setModel(new javax.swing.table.DefaultTableModel(matrizes, new String[]{"*Cod_Area", "Nombre",
                    "Tamaño", "Capacidad", "Disponibilidad", "Descripción", "*Id_Guardia", "Cod_Puesto"}));
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Area");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String codigo_area = txtCodigo.getText();
        ...
        try {
            ...
            Control_guardia cass = new Control_guardia(null, null, null, null, codigo_area);
            ObjectSet result = baseDeDatos.get(cass);
            if (result.size() > 0) {
                JOptionPane.showMessageDialog(this, "No se puede eliminar el Area porque tiene Controles de guardia asociados", "ERROR", 0);
                return;
            }

            // Busca el Area a eliminar
            Area revisar = new Area(codigo_area, null, null, 0, false, null, null, null);
            ...
            if (cassResult.size() == 0) {
                ...
                JOptionPane.showMessageDialog(null, "El Area se ha eliminado correctamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Area_ConsultarEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Area_ConsultarEliminar().setVisible(true);
            }
        });
    }
