 ...
 */
public class Negocio_ConsultarEliminar extends javax.swing.JFrame {

    /**
     * Creates new form Negocio_ConsultarEliminar
     */
    public Negocio_ConsultarEliminar() {
        initComponents();
    }
    ...
    public void MostrarDatos(ObjectSet result) {
        ...
        if (result.size() == 0) {
            ...
            for (int i = 0; i < result.size(); i++) {
                Negocio miObjeto = new Negocio();

                miObjeto = (Negocio) result.get(i);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Negocios");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String codigo_negocio = txtCodigo.getText();
        ...
        try {
            ...
            if (cassResult.size() == 0) {
                ...
                JOptionPane.showMessageDialog(null, "El Negocio se ha eliminado correctamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Negocio_ConsultarEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Negocio_ConsultarEliminar().setVisible(true);
            }
        });
    }
