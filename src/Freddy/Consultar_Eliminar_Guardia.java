 ...
 * @author Lenovo
 */
public class Consultar_Eliminar_Guardia extends javax.swing.JFrame {

    /**
     * Creates new form Consultar_Eliminar_Guardia
     */
    public Consultar_Eliminar_Guardia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jCBfiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una opción", "Ver todos", "ID Guardia", " ", " " }));
        ...
        jtableregistro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Guardia", "Cedula", "Nombre", "Apellido", "Edad", "Genero", "Celular", "Fecha Nacimiento", "Correo", "Cod_Tipo Sangre", "cod_Especialidad", "Cod_Pais", "Años Experiencia", "Disponibilidad", ""
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Eliminar_Guardia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Eliminar_Guardia().setVisible(true);
            }
        });
    }
